#' @export mp.results
#' @title Calculates various endpoints using results from RAMAS MP simulation
#' @description
...
#' @param ptc TRUE/FALSE - Is a *.ptc file included?  If yes, some spatial information can
#' be extracted from this file
#' @param ptcFiles A single path to a ptc file or a vector of ptc files with which to extract
#' data from.
#' @param ptcFileIter For each ptcFile, the corresponding iteration as noted in the HabDyn
