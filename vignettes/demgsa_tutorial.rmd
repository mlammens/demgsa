...
Each of the parameters that needs to be set is defined in this sens_config.txt 
file. The template is parameterized to run the sample model examined in this 
